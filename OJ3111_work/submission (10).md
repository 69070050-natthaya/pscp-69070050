...
```text
โจทย์ให้แสดงราคาส่วนลดของร้านสหกรณ์ในวันกีฬาสี

input: 
บรรทัดที่ 1 รับค่าว่าเป็นสมาชิกมั้ย
บรรทัดที่ 2 รับค่าจำนวนสินค้า n
ท บรรทัด ราคาของสินค้า n อัน

output:
ยอดรวมหลังหักส่วนลด

Constraints:
ต้องรับค่าราคาโดยใช้จำนวนสินค้ามาวนลูป
```
...
```text
step1 : รับค่าว่าเป็นสมาชิกมั้ย รับค่าจำนวนสินค้า
step2 : นำจำนวนสินค้ามาวนลูปเพื่อรับราคาสินค้าตามจำนวนสินค้า
step3 : เขียน if else ถ้าเป็นสมาชิก 5% ถ้าไม่เป็นแต่ซื้อครบ 500 ให้ลด 3%
step4 : แสดงผลเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
คล้ายวิธีแรกที่คิด แต่ใช้import decimal
```
...
```text
อยากลองรับตัวอักษรที่ไม่อยู่ในที่กำหนด
```
