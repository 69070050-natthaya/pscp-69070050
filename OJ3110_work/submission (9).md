...
```text
โจทย์ให้คำนวณภาษีจากต้นทางถึงปลายทาง

input : 
รับค่าของต้นทางและปลายทางเป็นบรรทัดเดียว
รับค่าน้ำหนักของพัสดุ

output : 
แสดงราคาภาษีของการนำส่งพัสดุ

 Constraints:
ค่าที่รับมาของต้นทางและปลายทางต้องเป็นตัวพิมพ์ใหญ่เท่านั้น
```
...
```text
step1 : รับค่าต้นทาง ปลายทาเป็น string และ ใช้คำสั่ง upper ทำให้เป็นตัวพิมพ์ใหญ่ และใช่ split เพื่อรับค่าบรรทัดเดียว
step2 : รับค่าน้ำหนักของสิ่งของ
step3 : เขียน if else เพื่อคิดภาษีตามตารางที่กำหนดและแสดงผลออกมา และ ถ้าไม่ตรงตามตารางให้แสดงว่า error
...
```text
วิธีสุดท้ายเหมือนตอนแรกที่คิดไว้
```
