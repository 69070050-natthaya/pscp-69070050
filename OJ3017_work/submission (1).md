...
```text
โจทย์ให้คำนวณค่าอาหารโดยคิดค่าบริการ10% และVAT 7% 
input: ค่าอาหารที่ลูกค้าสั่งไป
output: ค่าใช่จ่ายที่รวมค่าบริการ10% และVAT 7%
Constraints: VAT จะคิดด้วยราคาที่รวมค่าบริการแล้ว ค่าบริการคิดอย่างน้อย 50 บาท และไม่เกิน 1000 บาท
```
...
```text
step1 : รับค่าอาหารที่ลูกค้าสั่ง
step2 : คิดค่าบริการ หากต่ำกว่า 50 บาทให้คิด 50 บาทและหากมากกว่า 1000 บาทให่คิด 1000 บาท
step3 : นำค่าอาหารมารวมกับค่าบริการ
step4 : คิดVAT แล้้วนำราคาทั้งหมดมารวมกัน
step5 : แสดงราคาทั้งหมดออกมาเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
อยากลองค่าติดลบดู แต่ไม่น่าจะเกิดขึ้นได้
```
