...
```text
โจทย์ให้แปลงอุณหภูมิจากหน่วยหนึ่งไปอีกหน่วยหนึ่ง
input:
รับค่าอุณหภูมิ หน่วยอุณหภูมิที่รับมา และหน่วยที่อุณหภูมิต้องการจะแปลงไปเป็น
output:
อุณหภูมิที่แปลงแล้ว
Constraints:
สูตรให้แปลงจากค่าเชลเชียสเวลาทำจึงอาจต้องกลับสูตรหรือแปลงเป็นเชลเชียสก่อน
...
```text
step1 : รับค่าอุณหภูมิ หน่วยแรก และหน่วยที่ต้องการจะแปลง
step2 : เขียนif else แปลงจากเชลเชียสเป็นหน่วยอื่นๆ แล้ว print ออกมา
step3 : เขียน if else แปลงจากหน่วยอื่นกลับมาเป็นเชลเชียส แล้วแปลงเป็นหน่วยที่โจทย์ต้องการ แล้ว print ออกมา
```
...
```text
ใช้คล้ายกับวิธีแรกที่คิดไว้ แต่เพิ่มเงื่อนไขไปเพิ่มอย่างหนึ่ง
```
