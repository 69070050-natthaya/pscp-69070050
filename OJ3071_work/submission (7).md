...
```text
ให้หาเลขระหว่างa-bที่หารด้วยd แล้วเหลือเศษr

input:
รับค่าa เป็นตัวเลขแรก b เป็นตัวเลขสุดท้าย d เป็นตัวหาร และr เป็นเศษเหลือ

output:
จำนวนตัวที่หารด้วยd แล้วเหลือเศษr

Constraints:
ถ้าใช้loopอาจใช้เวลารันนานเกินไป
```
...
```text
step1 : รับค่า a b d r เป็นจำนวนเต็ม
step2 : ใช้ while loop นำค่า a มาลบ1 แล้วเก็บไว้ในลิส
step3 : นำค่าในลิสมาลองหาร d ทีละตัว ว่าค่าไหนหารแล้วเหลือเศษ r บ้าง
step4 : print คำตอบออกมาว่ามีกี่ตัว
```
...
```text
เนื่ิองจากวิธีแรกใช้เวลารันนานจนติด1 testcase จึงเปลี่ยนไม่เก็บไว้ในลิสแต่ใช้ fer loop รันเช็คทีละตัวแล้วแสดงoutput ออกมาเลย
```
...
```text
อยากให้ไม่มีอันไหนหารได้คำตอบเท่านั้นเลย
```
