...
```text
โจทย์ให้หาว่ามีสระแต่ละตัว aeiou กี่ตัวในคำที่ป้อนลงไป

input:
รับคำเป็นค่า string

output:
ถ้ามีตัวไหนให้print ออกมาเป็นตัวนั้น = และจำนวนที่นับได้

Constraints:
ตัวไหนที่ไม่มีจะไม่ต้องแสดง output ออกมา
```
...
```text
step1 : รับคำมาคำนึง
step2 : นับว่ามี aeiou กี่ตัวในคำที่รับมา
step3 : ถ้าจำนวนที่นับจากคำไม่ใช่0 จะแสดง output ออกมา
```
