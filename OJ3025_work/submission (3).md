...
```text
โจทย์ให้หาว่าวันที่เท่านี้เป็นฤดูอะไร
input: 
รับค่าวันและเดือนเป็นจำนวนเต็ม
output:
ชื่อฤดูที่วันที่ที่รับมานั้นอยู่
Constraints:
วันที่21ของเดือนที่หาร3ลงตัวจะเปลี่ยนเป็นอีกฤดูนึง
```
...
```text
step1 : รับค่าวันและเดือน
step2 : เขียน if else ตามที่โจทย์กำหนดว่าเดือนไหนเป็นฤดูอะไร
step3 : เขียนเงื่อนไขที่วันที่21 ของเดือนที่หาร3 ลงตัวเป็นอีกฤดูนึง
```
...
```text
คล้ายวิธีแรก แต่เปลี่ยนวิธีเขียนนิดหน่อยเนื่องจากติดpep8
```
...
```text
ลองรับค่าเป็นวันที่ 21 และเดือนที่หาร3ลงตัว
```
