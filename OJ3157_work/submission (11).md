...
```text
โจทย์ให้หาคะแนนรวมหลังรับ inputมาแล้ว

input:
บรรทัดที่1 : จำนวนเต็ม n
บรรทัดที่2 : เครื่งหมาย+หรือ-ตามจำนวน n รอบ

output:
คะแนนรวมท้ายสุด

Constraints:
ต้องใช้ loop รับค่า n รอบ
```
...
```text
step1:รับค่า n 
step2:ใช้loopรับค่า + หรือ - n บรรทัด
step3:ใช้if else เขียนเงื่อนไขถ้าเป็น + คะแนนจะเพิ่ม 10 และ ถ้าเป็น - คะแนนจะลบ 5
step4: print คะแนนรวมออกมา
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรกที่คิดไว้
```
