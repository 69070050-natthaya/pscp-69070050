...
```
โจทย์ให้รับข้อความยาวถตัวอักษรแล้วเปลี่ยนที่สลับหน้าไปหลัง
input: ข้อความภาษาอังกฤษที่ยาว 5 ตัวอักษร
outout: ข้อความที่สลับที่โดยเป็นพิมพ์เล็กทั้งหมด
constraints: inputที่รับมาต้องเป็น 5 ตัวอักษร และ พอ outputออกมาต้องเป็นตัวพิมพ์เล็กทั้งหมด
...
```
Step 1:รับ input ที่เป็น float
Step 2:ใช้ if แล้วใช้ len เพื่อนับตัวอักษรว่าครบ 5 มั้ย
Step 3:ถ้าหากครบ 5 ตัวก็ให้ print แบบเริ่มจากตัวท้ายโดยใช้ [::-1] แล้วใส่ .lower() เพื่อให้เป็นตัวพิมพ์เล็กทั้งหมด
```
...
```
วิธีสุดท้ายก็เหมือนกับตอนแรกที่คิดไว้ เพราะใช้ได้ผลตามที่คิดไว้
...
```
อยากให้ลองมีอักษรทั้งพิมใหญ่ พิมพ์เล็กปนกัน
