...
```text
โจทย์ให้นำสีมาผสมกันแล้วแสดงสีที่ผสมได้ออกมา
input: ชื่อสีที่จะนำผสมกัน
output: ชื่อสีที่ผสมได้
Constraints: ถ้าไม่มีสีที่กำหนดให้output เป็นerror
```
...
```text
step1: รับinputของสีทั้ง2
step2: ใช้if else ว่าสีที่รับมาผสมกันได้สีอะไร
step3: ถ้าไม่มีในสีที่กำหนดให้ output เป็น error
```
...
```text
คล้ายกับที่คิดไว้ตอนแรก เพิ่มมาตรงที่ถ้าทั้ง2สีที่รับมาเป็นสีเดียวกันให้outputแสดงสีเดิม
```
...
```text
เป็นสีเดียวกันแต่ไม่มีในสีที่กำหนด
```
