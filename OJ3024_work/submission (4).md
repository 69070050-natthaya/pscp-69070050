...
```text
ให้หาว่ามีโอกาสที่จะเกิด SurprisingVote หรือไม่

input:
คะแนนรวมของทั้ง 3 คน และ คะแนที่สูงสุงใน 3 คนนี้

output:
ถ้ามีโอการเป็นSurprisingVote ให้แสดงผลว่าSurprising แต่ถ้าไม่มีให้แสดงNot surprising

Constraints:
มีโอกาสที่คะแนนโหวตคิดออกมาแล้วจะเป็นเลขติดลบ
```
...
```text
step1 : รับinput ที่เป็นจำนวนเต็ม
step2 : คิดหาค่าต่ำสุดที่เป็นไปได้โดย นำเลขสูงสุดมาคูณ 2 แล้วลบคะแนนรวม
step3 : หากค่าต่ำสุดที่หามาได้ติดลบให้ เท่ากับ0
step4 : หาก ค่าสูงสุดและต่ำสุดที่เป็นไปได้ลบกันแล้วมากกว่า2 ให้แสดง output ตามโจทย์
```
...
```text
อยากให้ค่ามากที่สุดเป็นค่าที่น้อยจนไม่มีทางเกิดขึ้น
```
