...
```text
โจทย์ให้หาว่าสร้างสะพานความยาวเท่านี้ต้องใช้อิฐก้อนเล็กกี่ก้อน

input: 
รับจำนวนอิฐก้อนเล็กที่มี อิฐก้อนใหญ่ที่มี และ ความยาวของสะพานที่ต้องสร้าง

output:
จำนวนอิฐก้อนเล็กน้อยที่สุดที่ต้องใช้

Constraints:
ต้องใช้ก้อนใหญ่ให้ได้มากที่่สุดก่อน ถ้าก้อนใหญ่มีเกินให้ใช้เท่าที่ใช้ได้
```
...
```text
step1 : รับค่าอิฐก้อนเล็ก อิฐก้อนใหญ่ และเป้าหมายที่ต้องสร้าง
step2 : นำเป้าหมายมาลบกับก้อนใหญ่คูณ5
step3 : ถ้าส่วนที่เหลือ เท่ากับ ก้อนเล็กให้printจำนวนก้อนเล็ก ถ้าไม่ให้print-1
...
```text
วิธีแรกไม่ผ่านtestcase หลายอันมาก จึงลองเขียนเงื่อนไขใหม่ทั้งหมดได้ว่า
step1 : รับค่าอิฐก้อนเล็ก อิฐก้อนใหญ่ และเป้าหมายที่ต้องสร้าง
step2 : นำอิฐก้อนใหญ่ที่รับมามาคูณ5เพื่อหาความยาวทั้งหมดที่สร้างได้แล้วเก็บไว้ในตัวแปร big
step3 : ถ้าbig มากกว่าหรือเท่ากับเป้าหมายให้นำเป้าหมายหาร5แบบไม่เอาเศษแต่ถ้าไม่ให้ให้เท่ากับอิฐก้อนใหญ่เลยแล้วเก็บค่าไว้ในตัวแปร x
step4: ถ้าเป้าหมายลบx คูณ 5 น้อยกว่าหรือเท่ากับอิฐก้อนเล็ก ให้print เป้าหมายลบx คูณ 5 ถ้าไม่ให้print -1
```
...
```text
อยากให้มีอิฐก้อนใหญ่พอดีที่ต้องสร้าง
```
...
```text
เพื่อนที่เป็นคู่ pair
```

เขาช่วยอะไร

```text
ช่วยดูโค้ดให้แล้วก็ช่วยกันแก้
```

คุณยังทำอะไรด้วยตนเอง

```text
ช่วยเพื่อนเขียนและช่วยคิดตรงที่ติด
```
